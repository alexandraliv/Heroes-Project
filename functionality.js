class Hero { //clasa Parinte
    ...
    if (this.shield) {
        ...
        console.log(this.name + ' defends with the shield.');
    }

    this.hp -= damage; //this.hp = this.hp - damage;

    console.log(this.name + ' has beed attacked. HP reduced by ' + damage + '. HP remening: ' + this.hp + '.');
...
let dwarf = new Dwarf('Batman', 50);
let sprite = new Sprite('Ironman', 40);
let dragon = new Dragon('Spiderman', 60);
